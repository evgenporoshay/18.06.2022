...
$APPLICATION->SetTitle("Заявка \"Тест\"");
?><html>
    <head>
    </head>
    <body>
<h3> Заведение заявки "Попутчик" Тест </h3><br>
<form method="POST">
...
define('SECRET_CODE', 'uemssigq7winpix1'); # секретный код вебхука hdm0h95xstcrn8sk

define('PORTAL', 'http://bitrix.rdl-telecom.ru'); # адрес  CRM

define('USER_ID', 1); # ID администратора портала и владельца вебхука 310

define('ASSIGNED_BY_ID', 1); # ID ответсвенного
...
define('UF_CRM_1650007980763', 32); #Выставляем стандартный приоритет
...
$query1 = mysqli_query($link, "
   ...
   AND bcd.DATE_CREATE >= DATE_SUB(NOW(), INTERVAL 20 SECOND);");
...
#header("Location: https://bitrix.rdl-telecom.ru/scripts/poputchik/api_deal_bitrix.php?id=$id ");
