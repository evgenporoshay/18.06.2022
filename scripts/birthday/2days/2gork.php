...
bui.USER_ID = bu.ID
WHERE DATE_ADD(bu.PERSONAL_BIRTHDAY, INTERVAL YEAR(CURDATE())-YEAR(bu.PERSONAL_BIRTHDAY) + IF(DAYOFYEAR(CURDATE()) > DAYOFYEAR(bu.PERSONAL_BIRTHDAY), 1, 0) YEAR) = DATE_ADD(CURDATE(), INTERVAL 0 day)
...
$title .= '<b>Уважаемый Кирилл! </b><br /> <p>Через 2 дня у следующих сотрудников вашего отдела будет День Рождения! <br /> Не забудьте их поздравить!<br /></p>';
...
// $to  = "kk.korotkov@rdl-telecom.com," ;
