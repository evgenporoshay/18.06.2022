...
$result = $mysqli->query('SELECT NAME, LAST_NAME, DATE_FORMAT(PERSONAL_BIRTHDAY, ("%d.%m.%Y"))
FROM  b_user
...
$title .= '<b>Уважаемые Коллеги! </b><br /> <p>Завтра отмечают свой день рождения:</b><br /></p>';
