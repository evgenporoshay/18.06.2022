...
AND UF_DEPARTMENT_NAME = 'ЛВЧД-8 Санкт-Петербург' AND bu.ACTIVE = 'Y'"); // запрос на выборку
$count = mysqli_num_rows($result); // количество строк в запросе
$title .= '<b>Уважаемый Артур! </b><br /> <p>Через 10 дней у следующих сотрудников вашего отдела будет День Рождения! <br /> Не забудьте их поздравить!<br /></p>';
...
$to  = "a.goncharov@rdl-telecom.com," ;
