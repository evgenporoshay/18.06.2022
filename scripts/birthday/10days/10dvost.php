...
AND UF_DEPARTMENT_NAME = 'Дальневосточный филиал' AND bu.ACTIVE = 'Y'"); // запрос на выборку
$count = mysqli_num_rows($result); // количество строк в запросе
$title .= '<b>Уважаемый Павел! </b><br /> <p>Через 10 дней у следующих сотрудников вашего отдела будет День Рождения! <br /> Не забудьте их поздравить!<br /></p>';
