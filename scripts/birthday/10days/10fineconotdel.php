...
AND UF_DEPARTMENT_NAME = 'Финансово-экономический отдел' AND bu.ACTIVE = 'Y'"); // запрос на выборку
$count = mysqli_num_rows($result); // количество строк в запросе
$title .= '<b>Уважаемая Анастасия! </b><br /> <p>Через 10 дней у следующих сотрудников вашего отдела будет День Рождения! <br /> Не забудьте их поздравить!<br /></p>';
...
$to  = "a.kuznetsova@rdl-telecom.com," ;
