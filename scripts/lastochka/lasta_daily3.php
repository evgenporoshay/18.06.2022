...
# Всего в работе
$res_open_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:NEW' 
OR bcd.STAGE_ID = 'C35:PREPARATION'
OR bcd.STAGE_ID = 'C35:PREPAYMENT_INVOICE'
OR bcd.STAGE_ID = 'C35:EXECUTING'
OR bcd.STAGE_ID = 'C35:FINAL_INVOICE'
OR bcd.STAGE_ID = 'C35:1'
OR bcd.STAGE_ID = 'C35:2'");
$row_open_sum = $res_open_sum->fetch_row();
$count_open_sum = $row_open_sum[0];

# Всего просроченные
$res_dline_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:NEW' 
OR bcd.STAGE_ID = 'C35:PREPARATION'
OR bcd.STAGE_ID = 'C35:PREPAYMENT_INVOICE'
...
OR bcd.STAGE_ID = 'C35:1'
OR bcd.STAGE_ID = 'C35:2'
AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
# СТП просроченные
$res_dlinestp_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:NEW' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:PREPARATION'");
$row_sawork_sum = $res_sawork_sum->fetch_row();
$count_sawork_sum = $row_sawork_sum[0];

# Сисадмины просроченные
$res_sadwork_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:PREPARATION' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:PREPAYMENT_INVOICE'");
$row_orpo_work_sum = $res_orpo_work_sum->fetch_row();
$count_orpo_work_sum = $row_orpo_work_sum[0];

# ОРПО просроченные
$res_orpo_dwork_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:PREPAYMENT_INVOICE' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:EXECUTING'");
$row_prod_work_sum = $res_prod_work_sum->fetch_row();
$count_prod_work_sum = $row_prod_work_sum[0];

# Продукты просроченные
$res_prod_dwork_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:EXECUTING' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:FINAL_INVOICE'");
$row_szap_work_sum = $res_szap_work_sum->fetch_row();
$count_szap_work_sum = $row_szap_work_sum[0];

# ОЭ СЗАП просроченные
$res_szap_dwork_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:FINAL_INVOICE' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:1'");
$row_moskva_work_sum = $res_moskva_work_sum->fetch_row();
$count_moskva_work_sum = $row_moskva_work_sum[0];

# ОЭ Москва просроченные
$res_moskva_dwork_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:1' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
...
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:2'");
$row_yug_work_sum = $res_yug_work_sum->fetch_row();
$count_yug_work_sum = $row_yug_work_sum[0];

# ОЭ ЮГ просроченные
$res_yug_dwork_sum = $link->query("SELECT count(*) FROM b_uts_crm_deal bucd
JOIN b_crm_deal bcd ON bcd.id = bucd.VALUE_ID 
WHERE bcd.STAGE_ID = 'C35:2' AND UF_CRM_1611413941886  < CURRENT_TIMESTAMP();");
