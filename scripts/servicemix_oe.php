...
$query1 = mysqli_query($link, "
    ...
    WHERE bcm.STAGE_ID = 'C14:EXECUTING' /* Тут мы делаем запрос на стадии новой заявки СТП */
    AND bcm.DATE_MODIFY >= DATE_SUB(NOW(), INTERVAL 10 SECOND);");
...
$query4 = mysqli_query($link, "SELECT bcd.ID
    FROM b_crm_deal bcd
    WHERE bcd.STAGE_ID = 'C14:EXECUTING' /* Тут мы делаем запрос на стадии новой заявки СТП */
    AND bcd.DATE_MODIFY >= DATE_SUB(NOW(), INTERVAL 10 SECOND);");
